class Food:
    ...
    def flavorGetter(self):
        return self._flavor
    
    def ratingGetter(self):
        return self._rating
    
    def flavorSetter(self, newFlavor: str):
        self._flavor = newFlavor    
    def ratingSetter(self, newRating: int):
...
#     print(risotto.ratingGetter())
#     risotto.ratingSetter(4)
#     risotto.flavorSetter("salty")
#     print(risotto.ratingGetter())
#     print(risotto.flavorGetter())